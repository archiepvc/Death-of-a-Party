...
define gui.accent_color = '#ff9bd9'

## The color used for a text button when it is neither selected nor hovered.
define gui.idle_color = '#8d125d'
...
define gui.hover_color = '#ff9bd9'

## The color used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = '#ff9bd9'
...
define gui.text_font = "PafStandard-Regular.ttf"

## The font used for character names.
define gui.name_text_font = "PafStandard-Regular.ttf"

## The font used for out-of-game text.
define gui.interface_text_font = "PafStandard-Regular.ttf"
...
define gui.choice_button_text_idle_color = '#f7e9ef'
